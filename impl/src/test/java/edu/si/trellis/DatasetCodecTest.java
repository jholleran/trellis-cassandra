...
class DatasetCodecTest {
    ...
    @Test
    void badParse() {
        assertThrows(IllegalArgumentException.class, () -> datasetCodec.parse("SGDF   &&$$$dfshgou;sdfhgoudfhogh"));
    }
    ...
    @Test
    void badData() {
        assertThrows(IllegalArgumentException.class, () -> datasetCodec.encode(new BadDataset(), null));
    }
